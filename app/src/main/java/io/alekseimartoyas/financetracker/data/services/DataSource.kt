...
class DataSource : IDataSourceInput {
    ...
    override fun getTransactions(): Array<FinanceTransaction> {
        TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
    }
    ...
    private fun createFakeAccounts() {
        val transactions = ArrayList<FinanceTransaction>()
        transactions.add(FinanceTransaction(OperationType.DEBIT, 10f, Currency.RUB, CategoryType.Category1, "12-01-2010", 1))
        transactions.add(FinanceTransaction(OperationType.ENLISTMENT, 10f, Currency.RUB, CategoryType.Category2, "15-04-2012", 2))
        transactions.add(FinanceTransaction(OperationType.DEBIT, 10f, Currency.RUB, CategoryType.Category3, "24-08-2014", 3))

        val transactions2 = ArrayList<FinanceTransaction>()
        transactions2.add(FinanceTransaction(OperationType.DEBIT, 10f, Currency.RUB, CategoryType.Category1, "12-01-2010", 1))
        transactions2.add(FinanceTransaction(OperationType.DEBIT, 10f, Currency.RUB, CategoryType.Category3, "24-08-2014", 3))

        val transactions3 = ArrayList<FinanceTransaction>()
        transactions3.add(FinanceTransaction(OperationType.ENLISTMENT, 10f, Currency.RUB, CategoryType.Category2, "15-04-2012", 2))
